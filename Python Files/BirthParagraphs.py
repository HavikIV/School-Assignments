...
num = easygui.enterbox('Enter your birth number (1-9)')

if num == '1':
        easygui.msgbox("1's are originals. Coming up with new ideas and executing them is \
...
Judd, Nancy Reagan, Raque l Welch.", title = '#1 THE ORIGINATOR')
elif num == '2':
        easygui.msgbox("2's are the born diplomats. They are aware of others' needs and moods \
...
Edison, Wolfgang Amadeus Mozart.", title = '#2 - THE PEACEMAKER')
elif num == '3':
        easygui.msgbox("3's are idealists. They are very creative, social, charming, romantic, \
...
Famous 3's: Alan Alder, Ann Landers, Bill Cosby, Melanie Griffith, Salvador Dali, Jodi Foster.", title = '#3 THE LIFE OF THE PARTY')
elif num == '4':
        easygui.msgbox("4's are sensible and traditional. They like order and routine. They only \
...
Turner, Paul Hogan, Oprah Winfrey.", title = '#4 - THE CONSERVATIVE')
elif num == '5':
        easygui.msgbox("5's are the explorers. Their natural curiosity, risk taking, and \
...
Van Gogh, Bette Midler, Helen Keller and Mark Hail.", title = '#5 - THE NONCONFORMIST') 
elif num == '6':
        easygui.msgbox("6's are idealistic and need to feel useful to be happy. A strong family \
...
Streep, Christopher Columbus, Goldie Hawn.", title = '#6 - THE ROMANTIC')
elif num == '7':
        easygui.msgbox("7's are the searchers. Always probing for hidden information, they find \
...
Baez, Princess Diana.", title = '#7 - THE INTELLECTUAL')
elif num == '8':
        easygui.msgbox("8's are the problem solvers. They are professional, blunt and to the \
...
Pablo Picasso, Aretha Franklin, Nostrodamus.", title = '#8 THE BIG SHOT')
elif num == '9':
        easygui.msgbox("9's are natural entertainers. They are very caring and generous, giving \
...
Carter, Elvis Presley.", title = '#9 THE PERFORMER')
else:
        easygui.msgbox("You enter a number greater than 9", title = 'Wrong Number')
